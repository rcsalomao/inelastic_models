...
This repository contains some inelastic models implementations. Such models are employed to represent materials with inelastic behaviours like plasticity or damage.
...
This repo has the **gnuplot-iostream** library as a dependency for graph plotting.
...
[1]: de Souza Neto, E. A., Peric, D., & Owen, D. R. J. (2008). Computational methods for plasticity: Theory and applications. Hoboken, NJ: Wiley-Blackwell.
